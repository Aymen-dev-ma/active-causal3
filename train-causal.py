...
from src.tfmodel import CausalInferenceModel  # Assuming CausalInferenceModel is defined in tfmodel
...
game_test = Game(1)
model = CausalInferenceModel(s_dim=s_dim, pi_dim=pi_dim, gamma=gamma, beta_s=beta_s, beta_o=beta_o, colour_channels=1, resolution=64)  # Instantiate causal model
